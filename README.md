...
<p align="justify">
L’Initial Public Offering (IPO), est le processus par lequel une entreprise privée parvient à être introduite en bourse en offrant ses actions au public pour la première fois. L'IPO offre à une entreprise la possibilité de lever des fonds importants en vendant des actions sur le marché boursier. L’introduction en bourse et notamment la capitalisation boursière est souvent utilisée comme indicateur de la valeur totale du marché des actions d'une entreprise. 
